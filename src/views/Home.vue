<template>
	<section class="content">
		<div class="welcome-section">
			<svg class="welcome-section__arrow" viewBox="0 0 256 400" xmlns="http://www.w3.org/2000/svg">
				<path
			...
			<p class="welcome-section__text">Utiliza la caja de búsqueda para encontrar tu peli.</p>
		</div>
	</section>
</template>
